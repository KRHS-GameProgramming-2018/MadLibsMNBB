...
def playMadlibs():
    ...
    output+= " The prince \ncharged the castle, wielding a "  + food1 + " of unusual size. "
    output+= " Out of nowhere, the princess's father, " + god1 + "\nroundhouse kicked the charging prince. "
    output+=  god1 + " called down a plague of " + rodent1 + "."
    output+= " The brave price retreated, tripping over a wild " + object1
    output+= " The swarm of " + rodent1 + " surrounded the panicking prince, " + verb1 + " him in seconds."
